...
public class Tile {
	...
	/**
	 * The number of rows in this piece. (Only valid when rotation is 0 or 2, but
	 * it's fine since we're only using it for displaying the next piece preview,
	 * which uses rotation 0).
	 */
	private int rows;

	/**
	 * The number of columns in this piece. (Only valid when rotation is 0 or 2, but
	 * it's fine since we're only using it for displaying the next piece preview,
	 * which uses rotation 0).
	 */
	private int cols;
	 ...
	 * 2, but it's fine since this is only used for the preview which uses rotation
	 * 0).
	 * 
	 ...
	 * the array for the given rotation.
	 * 
	 * @param rotation The rotation.
